        ...
        <div className={styles.funGalleryContainer}>
          ...
          <div className={styles.funGalleryGrid}>
            ...
            <div className={styles.funCard}>
              <img src="/assets/arte-digital.jpg" alt="Arte Digital" className={styles.funCardImage} />
            ...
            {/* Card 2: Fotografia */}
            <div className={styles.funCard}>
              <img src="/assets/fotografia.jpg" alt="Fotografia" className={styles.funCardImage} />
              <div className={styles.funCardContent}>
            ...
            {/* Card 3: Escultura */}
            <div className={styles.funCard}>
              <img src="/assets/escultura.jpg" alt="Escultura" className={styles.funCardImage} />
              <div className={styles.funCardContent}>
            ...
            {/* Card 4: Pintura */}
            <div className={styles.funCard}>
              <img src="/assets/pintura.jpg" alt="Pintura" className={styles.funCardImage} />
              <div className={styles.funCardContent}>

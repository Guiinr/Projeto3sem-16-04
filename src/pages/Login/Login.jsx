      ...
      <div className={styles.loginContainer}>
        ...
        <form className={styles.loginForm} onSubmit={handleSubmit}>
          ...
          <div className={styles.forgotPassword}>
            <a href="/recuperar-senha" className={styles.forgotLink}>Esqueceu sua senha?</a>
          </div>
          ...
          <div className={styles.registerLink}>
            Não tem uma conta? <a href="/cadastro" className={styles.registerLinkText}>Cadastre-se</a>
          </div>
        </form>
      </div>
    </section>
